...
public class RatedShipmentDetail  implements java.io.Serializable {
     ...
     * 
     * @return adjustedCodCollectionAmount   * Express COD is shipment level.
     */
     ...
     * 
     * @param adjustedCodCollectionAmount   * Express COD is shipment level.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "RatedShipmentDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "ShipmentRateDetail"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "ShipmentRateDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("ratedPackages");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "RatedPackages"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "RatedPackageDetail"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
