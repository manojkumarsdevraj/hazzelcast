...
public class SpecialRatingAppliedType implements java.io.Serializable {
    ...
    public static SpecialRatingAppliedType fromValue(java.lang.String value)
        ...
        SpecialRatingAppliedType enumeration = (SpecialRatingAppliedType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SpecialRatingAppliedType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "SpecialRatingAppliedType"));
    }
    /**
