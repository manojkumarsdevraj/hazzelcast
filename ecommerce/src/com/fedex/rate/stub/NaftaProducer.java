...
public class NaftaProducer  implements java.io.Serializable {
    ...
    private com.fedex.rate.stub.Party producer;
    ...
    public NaftaProducer(
           java.lang.String id,
           com.fedex.rate.stub.Party producer) {
           this.id = id;
     ...
     * @return producer
     */
    public com.fedex.rate.stub.Party getProducer() {
        return producer;
    }
     ...
     * @param producer
     */
    public void setProducer(com.fedex.rate.stub.Party producer) {
        this.producer = producer;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "NaftaProducer"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "Producer"));
