...
public class HazardousCommodityDescriptionProcessingOptionType implements java.io.Serializable {
    ...
    public static HazardousCommodityDescriptionProcessingOptionType fromValue(java.lang.String value)
        ...
        HazardousCommodityDescriptionProcessingOptionType enumeration = (HazardousCommodityDescriptionProcessingOptionType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HazardousCommodityDescriptionProcessingOptionType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "HazardousCommodityDescriptionProcessingOptionType"));
    }
    /**
