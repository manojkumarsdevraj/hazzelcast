...
public class Payor  implements java.io.Serializable {
    private com.fedex.rate.stub.Party responsibleParty;

    public Payor() {
    }

    public Payor(
           com.fedex.rate.stub.Party responsibleParty) {
     ...
     */
    public com.fedex.rate.stub.Party getResponsibleParty() {
        return responsibleParty;
    }
     ...
     */
    public void setResponsibleParty(com.fedex.rate.stub.Party responsibleParty) {
        this.responsibleParty = responsibleParty;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "Payor"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("responsibleParty");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "ResponsibleParty"));
