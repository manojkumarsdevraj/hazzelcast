...
public class EMailNotificationRecipient  implements java.io.Serializable {
    ...
    private com.fedex.rate.stub.EMailNotificationEventType[] notificationEventsRequested;
    ...
    public EMailNotificationRecipient(
           ...
           com.fedex.rate.stub.EMailNotificationEventType[] notificationEventsRequested,
     ...
     */
    public com.fedex.rate.stub.EMailNotificationEventType[] getNotificationEventsRequested() {
     ...
     */
    public void setNotificationEventsRequested(com.fedex.rate.stub.EMailNotificationEventType[] notificationEventsRequested) {
        this.notificationEventsRequested = notificationEventsRequested;
    }

    public com.fedex.rate.stub.EMailNotificationEventType getNotificationEventsRequested(int i) {
        return this.notificationEventsRequested[i];
    }

    public void setNotificationEventsRequested(int i, com.fedex.rate.stub.EMailNotificationEventType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "EMailNotificationRecipient"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("EMailNotificationRecipientType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "EMailNotificationRecipientType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "EMailNotificationRecipientType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("EMailAddress");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "EMailAddress"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "NotificationEventsRequested"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "EMailNotificationEventType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "Format"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "EMailNotificationFormatType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
