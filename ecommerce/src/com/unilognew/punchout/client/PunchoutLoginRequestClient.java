package com.unilognew.punchout.client;
...
public class PunchoutLoginRequestClient {
    
    /**
     *
     * Usage:
     *          PunchoutLoginRequestClient http://127.0.0.1/PunchoutRequest c:/APunchout/punchOutLoginRequest.xml
     *
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length != 2) {
            System.out.println(
                ...
                " PunchoutLoginRequestClient <url> <filename>]");
