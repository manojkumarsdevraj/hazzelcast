...
public class AlcoholRecipientType implements java.io.Serializable {
    ...
    public static AlcoholRecipientType fromValue(java.lang.String value)
        ...
        AlcoholRecipientType enumeration = (AlcoholRecipientType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AlcoholRecipientType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "AlcoholRecipientType"));
    }
    /**
