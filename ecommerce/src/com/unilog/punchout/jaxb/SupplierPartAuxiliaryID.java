...
public class SupplierPartAuxiliaryID
    implements Serializable, Equals, HashCode, ToString
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -202313994388759971L;
	@XmlMixed
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SupplierPartAuxiliaryID)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SupplierPartAuxiliaryID that = ((SupplierPartAuxiliaryID) object);
        {
