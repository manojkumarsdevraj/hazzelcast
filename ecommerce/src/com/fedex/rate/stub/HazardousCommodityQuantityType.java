...
public class HazardousCommodityQuantityType implements java.io.Serializable {
    ...
    public static HazardousCommodityQuantityType fromValue(java.lang.String value)
        ...
        HazardousCommodityQuantityType enumeration = (HazardousCommodityQuantityType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HazardousCommodityQuantityType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "HazardousCommodityQuantityType"));
    }
    /**
