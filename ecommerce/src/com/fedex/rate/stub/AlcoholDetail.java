...
public class AlcoholDetail  implements java.io.Serializable {
    ...
    private com.fedex.rate.stub.AlcoholRecipientType recipientType;

    public AlcoholDetail() {
    }

    public AlcoholDetail(
           com.fedex.rate.stub.AlcoholRecipientType recipientType) {
     ...
     */
    public com.fedex.rate.stub.AlcoholRecipientType getRecipientType() {
     ...
     */
    public void setRecipientType(com.fedex.rate.stub.AlcoholRecipientType recipientType) {
        this.recipientType = recipientType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "AlcoholDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("recipientType");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "RecipientType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "AlcoholRecipientType"));
