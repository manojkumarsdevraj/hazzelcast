...
public class ShippingDocumentDispositionType implements java.io.Serializable {
    ...
    public static final java.lang.String _DEFERRED_QUEUED = "DEFERRED_QUEUED";
    ...
    public static final ShippingDocumentDispositionType DEFERRED_QUEUED = new ShippingDocumentDispositionType(_DEFERRED_QUEUED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "ShippingDocumentDispositionType"));
    }
    /**
