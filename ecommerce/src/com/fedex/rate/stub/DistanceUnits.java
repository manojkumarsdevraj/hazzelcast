...
public class DistanceUnits implements java.io.Serializable {
    ...
    // Constructor
    protected DistanceUnits(java.lang.String value) {
        _value_ = value;
    ...
    public static DistanceUnits fromValue(java.lang.String value)
    ...
    public static DistanceUnits fromString(java.lang.String value)
          throws java.lang.IllegalArgumentException {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "DistanceUnits"));
    }
    /**
