    ...
    implements Serializable, Equals, HashCode, ToString
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6458493990031377859L;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SupplierDataRequest)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SupplierDataRequest that = ((SupplierDataRequest) object);
        {
