...
public class EMailNotificationFormatType implements java.io.Serializable {
    ...
    public static EMailNotificationFormatType fromString(java.lang.String value)
          throws java.lang.IllegalArgumentException {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "EMailNotificationFormatType"));
    }
    /**
