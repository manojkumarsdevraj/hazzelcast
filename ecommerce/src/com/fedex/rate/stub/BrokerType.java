...
public class BrokerType implements java.io.Serializable {
    ...
    public static BrokerType fromValue(java.lang.String value)
        ...
        BrokerType enumeration = (BrokerType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BrokerType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "BrokerType"));
    }
    /**
