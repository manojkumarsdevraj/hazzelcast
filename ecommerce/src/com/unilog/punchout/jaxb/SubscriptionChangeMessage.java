    ...
    implements Serializable, Equals, HashCode, ToString
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2100562481534196482L;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SubscriptionChangeMessage)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SubscriptionChangeMessage that = ((SubscriptionChangeMessage) object);
        {
