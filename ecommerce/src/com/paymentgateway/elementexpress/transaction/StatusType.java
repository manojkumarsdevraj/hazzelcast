...
public class StatusType implements java.io.Serializable {
    ...
    public static final StatusType Disabled = new StatusType(_Disabled);
    public static final StatusType Removed = new StatusType(_Removed);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://transaction.elementexpress.com", "StatusType"));
    }
    /**
