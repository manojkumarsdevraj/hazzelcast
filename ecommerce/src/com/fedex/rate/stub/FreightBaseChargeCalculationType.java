...
public class FreightBaseChargeCalculationType implements java.io.Serializable {
    ...
    public static FreightBaseChargeCalculationType fromValue(java.lang.String value)
        ...
        FreightBaseChargeCalculationType enumeration = (FreightBaseChargeCalculationType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FreightBaseChargeCalculationType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "FreightBaseChargeCalculationType"));
    }
    /**
