...
public class FreightAddressLabelDetail  implements java.io.Serializable {
     ...
     * will start. */
    private com.fedex.rate.stub.PageQuadrantType startingPosition;
    ...
    public FreightAddressLabelDetail(
           ...
           com.fedex.rate.stub.PageQuadrantType startingPosition,
     ...
     * will start.
     */
    public com.fedex.rate.stub.PageQuadrantType getStartingPosition() {
     ...
     * will start.
     */
    public void setStartingPosition(com.fedex.rate.stub.PageQuadrantType startingPosition) {
        this.startingPosition = startingPosition;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "FreightAddressLabelDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "Copies"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "StartingPosition"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "PageQuadrantType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
