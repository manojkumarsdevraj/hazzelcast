...
public class FreightRateQuoteType implements java.io.Serializable {
    ...
    public static FreightRateQuoteType fromValue(java.lang.String value)
        ...
        FreightRateQuoteType enumeration = (FreightRateQuoteType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FreightRateQuoteType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "FreightRateQuoteType"));
    }
    /**
