...
public class TimeCheckResponse  implements java.io.Serializable {
    private com.paymentgateway.elementexpress.transaction.Response response;

    public TimeCheckResponse() {
    }
    ...
    /**
     * Gets the response value for this TimeCheckResponse.
     * 
     * @return response
     */
    ...
    /**
     * Sets the response value for this TimeCheckResponse.
     * 
     * @param response
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TimeCheckResponse)) return false;
        TimeCheckResponse other = (TimeCheckResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TimeCheckResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://transaction.elementexpress.com", ">TimeCheckResponse"));
