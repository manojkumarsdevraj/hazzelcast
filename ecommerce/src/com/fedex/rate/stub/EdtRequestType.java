...
public class EdtRequestType implements java.io.Serializable {
    ...
    public static EdtRequestType fromValue(java.lang.String value)
        ...
        EdtRequestType enumeration = (EdtRequestType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EdtRequestType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "EdtRequestType"));
    }
    /**
