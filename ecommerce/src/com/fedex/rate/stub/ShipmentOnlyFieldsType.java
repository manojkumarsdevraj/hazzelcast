...
public class ShipmentOnlyFieldsType implements java.io.Serializable {
    ...
    // Constructor
    protected ShipmentOnlyFieldsType(java.lang.String value) {
        _value_ = value;
    ...
    public static ShipmentOnlyFieldsType fromValue(java.lang.String value)
    ...
    public static ShipmentOnlyFieldsType fromString(java.lang.String value)
          throws java.lang.IllegalArgumentException {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "ShipmentOnlyFieldsType"));
    }
    /**
