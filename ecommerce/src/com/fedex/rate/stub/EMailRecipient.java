...
public class EMailRecipient  implements java.io.Serializable {
    ...
    private com.fedex.rate.stub.AccessorRoleType role;

    /* Specifies how the email notification for the pending shipment
     * need to be processed. */
    private com.fedex.rate.stub.EmailOptionsRequested optionsRequested;
    ...
    public EMailRecipient(
           ...
           com.fedex.rate.stub.AccessorRoleType role,
           com.fedex.rate.stub.EmailOptionsRequested optionsRequested,
     ...
     */
    public com.fedex.rate.stub.AccessorRoleType getRole() {
        return role;
    }
     ...
     */
    public void setRole(com.fedex.rate.stub.AccessorRoleType role) {
        this.role = role;
    }
     ...
     * need to be processed.
     */
    public com.fedex.rate.stub.EmailOptionsRequested getOptionsRequested() {
     ...
     * need to be processed.
     */
    public void setOptionsRequested(com.fedex.rate.stub.EmailOptionsRequested optionsRequested) {
        this.optionsRequested = optionsRequested;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "EMailRecipient"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "AccessorRoleType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "EmailOptionsRequested"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
