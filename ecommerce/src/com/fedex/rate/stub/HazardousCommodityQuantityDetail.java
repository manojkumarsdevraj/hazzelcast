...
public class HazardousCommodityQuantityDetail  implements java.io.Serializable {
    ...
    private com.fedex.rate.stub.HazardousCommodityQuantityType quantityType;
    ...
    public HazardousCommodityQuantityDetail(
           ...
           com.fedex.rate.stub.HazardousCommodityQuantityType quantityType) {
           this.amount = amount;
           this.units = units;
     ...
     */
    public com.fedex.rate.stub.HazardousCommodityQuantityType getQuantityType() {
        return quantityType;
    }
     ...
     */
    public void setQuantityType(com.fedex.rate.stub.HazardousCommodityQuantityType quantityType) {
        this.quantityType = quantityType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "HazardousCommodityQuantityDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "Units"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "QuantityType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "HazardousCommodityQuantityType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
