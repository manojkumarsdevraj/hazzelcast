...
public class ScheduledTask  implements java.io.Serializable {
    ...
    private com.paymentgateway.elementexpress.services.RunFrequency runFrequency;

    private java.lang.String runStartDate;

    private com.paymentgateway.elementexpress.services.BooleanType runUntilCancelFlag;

    private java.lang.String runCycles;

    private com.paymentgateway.elementexpress.services.StatusType scheduledTaskStatus;
    ...
    public ScheduledTask(
           ...
           com.paymentgateway.elementexpress.services.RunFrequency runFrequency,
           java.lang.String runStartDate,
           com.paymentgateway.elementexpress.services.BooleanType runUntilCancelFlag,
           java.lang.String runCycles,
           com.paymentgateway.elementexpress.services.StatusType scheduledTaskStatus) {
     ...
     * @return runFrequency
     */
    public com.paymentgateway.elementexpress.services.RunFrequency getRunFrequency() {
        return runFrequency;
    }
     ...
     * @param runFrequency
     */
    public void setRunFrequency(com.paymentgateway.elementexpress.services.RunFrequency runFrequency) {
        this.runFrequency = runFrequency;
    }
     ...
     */
    public com.paymentgateway.elementexpress.services.BooleanType getRunUntilCancelFlag() {
        return runUntilCancelFlag;
    }
     ...
     */
    public void setRunUntilCancelFlag(com.paymentgateway.elementexpress.services.BooleanType runUntilCancelFlag) {
        this.runUntilCancelFlag = runUntilCancelFlag;
    }
     ...
     */
    public com.paymentgateway.elementexpress.services.StatusType getScheduledTaskStatus() {
        return scheduledTaskStatus;
    }
     ...
     */
    public void setScheduledTaskStatus(com.paymentgateway.elementexpress.services.StatusType scheduledTaskStatus) {
        this.scheduledTaskStatus = scheduledTaskStatus;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://services.elementexpress.com", "ScheduledTask"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://services.elementexpress.com", "ScheduledTaskRunLogID"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://services.elementexpress.com", "RunFrequency"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://services.elementexpress.com", "RunCycles"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://services.elementexpress.com", "StatusType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
