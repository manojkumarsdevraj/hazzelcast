...
public class HazardousCommodityRegulationType implements java.io.Serializable {
    ...
    public static HazardousCommodityRegulationType fromString(java.lang.String value)
          throws java.lang.IllegalArgumentException {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "HazardousCommodityRegulationType"));
    }
    /**
