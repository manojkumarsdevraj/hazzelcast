    ...
    implements Serializable, Equals, HashCode, ToString
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2737532922606296911L;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            SupplierList theSupplierList;
            theSupplierList = this.getSupplierList();
            strategy.appendField(locator, this, "supplierList", buffer, theSupplierList);
        }
        {
            ShipTo theShipTo;
        ...
        {
            List<Distribution> theDistribution;
            theDistribution = (((this.distribution!= null)&&(!this.distribution.isEmpty()))?this.getDistribution():null);
            strategy.appendField(locator, this, "distribution", buffer, theDistribution);
        }
        {
        ...
        {
            String theAgreementItemNumber;
            theAgreementItemNumber = this.getAgreementItemNumber();
            strategy.appendField(locator, this, "agreementItemNumber", buffer, theAgreementItemNumber);
        }
        {
            String theRequestedDeliveryDate;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ItemOut)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ItemOut that = ((ItemOut) object);
        {
            ItemID lhsItemID;
        ...
        {
            SupplierList lhsSupplierList;
            lhsSupplierList = this.getSupplierList();
            SupplierList rhsSupplierList;
            rhsSupplierList = that.getSupplierList();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "supplierList", lhsSupplierList), LocatorUtils.property(thatLocator, "supplierList", rhsSupplierList), lhsSupplierList, rhsSupplierList)) {
                return false;
            }
        }
        {
        ...
        {
            List<Distribution> lhsDistribution;
            lhsDistribution = (((this.distribution!= null)&&(!this.distribution.isEmpty()))?this.getDistribution():null);
            List<Distribution> rhsDistribution;
            rhsDistribution = (((that.distribution!= null)&&(!that.distribution.isEmpty()))?that.getDistribution():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "distribution", lhsDistribution), LocatorUtils.property(thatLocator, "distribution", rhsDistribution), lhsDistribution, rhsDistribution)) {
                return false;
            }
        }
        {
        ...
        {
            String lhsAgreementItemNumber;
            lhsAgreementItemNumber = this.getAgreementItemNumber();
            String rhsAgreementItemNumber;
            rhsAgreementItemNumber = that.getAgreementItemNumber();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "agreementItemNumber", lhsAgreementItemNumber), LocatorUtils.property(thatLocator, "agreementItemNumber", rhsAgreementItemNumber), lhsAgreementItemNumber, rhsAgreementItemNumber)) {
                return false;
            }
        }
        {
            String lhsRequestedDeliveryDate;
            lhsRequestedDeliveryDate = this.getRequestedDeliveryDate();
            String rhsRequestedDeliveryDate;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            SupplierList theSupplierList;
            theSupplierList = this.getSupplierList();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "supplierList", theSupplierList), currentHashCode, theSupplierList);
        }
        {
            ShipTo theShipTo;
            theShipTo = this.getShipTo();
        ...
        }
        {
            List<Distribution> theDistribution;
            theDistribution = (((this.distribution!= null)&&(!this.distribution.isEmpty()))?this.getDistribution():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "distribution", theDistribution), currentHashCode, theDistribution);
        }
        {
            List<Contact> theContact;
            theContact = (((this.contact!= null)&&(!this.contact.isEmpty()))?this.getContact():null);
        ...
        }
        {
            String theAgreementItemNumber;
            theAgreementItemNumber = this.getAgreementItemNumber();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "agreementItemNumber", theAgreementItemNumber), currentHashCode, theAgreementItemNumber);
        }
        {
            String theRequestedDeliveryDate;
            theRequestedDeliveryDate = this.getRequestedDeliveryDate();
