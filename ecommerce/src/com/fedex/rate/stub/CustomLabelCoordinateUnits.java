...
public class CustomLabelCoordinateUnits implements java.io.Serializable {
    ...
    public static CustomLabelCoordinateUnits fromValue(java.lang.String value)
        ...
        CustomLabelCoordinateUnits enumeration = (CustomLabelCoordinateUnits)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CustomLabelCoordinateUnits.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "CustomLabelCoordinateUnits"));
    }
    /**
