...
public class DocTabContentBarcoded  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "DocTabContentBarcoded"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("symbology");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "Symbology"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "Specification"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "DocTabZoneSpecification"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
