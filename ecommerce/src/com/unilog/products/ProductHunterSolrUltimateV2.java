...
public class ProductHunterSolrUltimateV2 {
...
//	static String solrURL = "http://192.168.1.24:8983/solrVanMeter/";
	...
	public static ProductsModel solrSearchResult(String narrowKeyword, String queryString,String connUrl,String[] attrFtr,int fromRow,int resultPerPage,String innerUrl,String fields[],String origKeyWord,String sortField,ORDER sortOrder, boolean includePartNumberSearch,boolean isAdvancedSearch, ArrayList<ProductsModel> itemLevelFilterData, String customerPartIdList, String[] attrFtrGlobal, String fq, LinkedHashMap<String, ArrayList<String>> filteredMultList,boolean wildCardSearch,boolean orSearch,boolean singleItem, boolean isProductGroup,String viewFrequentlyPurcahsedOnly,boolean isPromotion, boolean isExcludeItems, String elevateIds, String excludeItems, BannerEntity bannerEntity)
	{
		HttpSolrServer server = null;
		ProductsModel solrSearchVal = new ProductsModel();
		try
	...
	public static String[]  getFaucetFieldByName(String connUrl,String categoryName,String queryString,String innerUrl,int treeId, ArrayList<ProductsModel> refinedList,boolean isPriceRange,boolean isBrand,boolean isDifferentiator,boolean isSelectable,ArrayList<String> defaultFacet,ArrayList<String> arrayList)
	{
		HttpSolrServer server1 = null;
		HttpSolrServer server2 = null;
		String faucetFieldList[] = null;
	...
	public static String[]  getFaucetFieldForSearch(String queryString,String innerUrl,int treeId, ArrayList<ProductsModel> refinedList,boolean isPriceRange,boolean isBrand,boolean isDifferentiator,boolean isSelectable,ArrayList<String> defaultFacet,ArrayList<String> arrayList)
	{
	...
	public static void buildBoostQuery(SolrQuery query,String keyWord){
		try{
			...
			String key = "searchKeyword_";
			String val = "_val_:searchKeywordScore_";
