...
public class EmailOptionsRequested  implements java.io.Serializable {
    private com.fedex.rate.stub.EmailOptionType[] options;

    public EmailOptionsRequested() {
    }

    public EmailOptionsRequested(
           com.fedex.rate.stub.EmailOptionType[] options) {
     ...
     * @return options
     */
    public com.fedex.rate.stub.EmailOptionType[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.fedex.rate.stub.EmailOptionType[] options) {
        this.options = options;
    }

    public com.fedex.rate.stub.EmailOptionType getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, com.fedex.rate.stub.EmailOptionType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "EmailOptionsRequested"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("options");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "Options"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "EmailOptionType"));
