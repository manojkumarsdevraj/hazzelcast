...
public class HazardousContainerPackingType implements java.io.Serializable {
    ...
    public static HazardousContainerPackingType fromValue(java.lang.String value)
        ...
        HazardousContainerPackingType enumeration = (HazardousContainerPackingType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HazardousContainerPackingType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "HazardousContainerPackingType"));
    }
    /**
