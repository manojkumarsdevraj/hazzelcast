...
public class EMailLabelDetail  implements java.io.Serializable {
    ...
    private com.fedex.rate.stub.EMailRecipient[] recipients;
    ...
    public EMailLabelDetail(
           ...
           com.fedex.rate.stub.EMailRecipient[] recipients) {
     ...
     * @return recipients
     */
    public com.fedex.rate.stub.EMailRecipient[] getRecipients() {
        return recipients;
    }
     ...
     * @param recipients
     */
    public void setRecipients(com.fedex.rate.stub.EMailRecipient[] recipients) {
        this.recipients = recipients;
    }

    public com.fedex.rate.stub.EMailRecipient getRecipients(int i) {
        return this.recipients[i];
    }

    public void setRecipients(int i, com.fedex.rate.stub.EMailRecipient _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "EMailLabelDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "Recipients"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "EMailRecipient"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
