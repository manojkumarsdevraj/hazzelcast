...
@XmlRootElement(name = "MinReleaseAmount")
public class MinReleaseAmount
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MinReleaseAmount)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final MinReleaseAmount that = ((MinReleaseAmount) object);
        {
            Money lhsMoney;
