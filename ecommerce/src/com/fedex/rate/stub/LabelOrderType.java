...
public class LabelOrderType implements java.io.Serializable {
    ...
    public static LabelOrderType fromValue(java.lang.String value)
        ...
        LabelOrderType enumeration = (LabelOrderType)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LabelOrderType.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "LabelOrderType"));
    }
    /**
