    ...
    implements Serializable, Equals, HashCode, ToString
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4097291218973539543L;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SupplierListResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SupplierListResponse that = ((SupplierListResponse) object);
        {
