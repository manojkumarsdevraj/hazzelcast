...
public class ReturnEMailDetail  implements java.io.Serializable {
    ...
    public com.fedex.rate.stub.ReturnEMailAllowedSpecialServiceType getAllowedSpecialServices(int i) {
        return this.allowedSpecialServices[i];
    }

    public void setAllowedSpecialServices(int i, com.fedex.rate.stub.ReturnEMailAllowedSpecialServiceType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "ReturnEMailDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("merchantPhoneNumber");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "MerchantPhoneNumber"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "AllowedSpecialServices"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "ReturnEMailAllowedSpecialServiceType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
