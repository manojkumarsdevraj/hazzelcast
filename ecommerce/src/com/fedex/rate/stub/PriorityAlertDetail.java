...
public class PriorityAlertDetail  implements java.io.Serializable {
    private com.fedex.rate.stub.PriorityAlertEnhancementType[] enhancementTypes;
    ...
    public PriorityAlertDetail(
           com.fedex.rate.stub.PriorityAlertEnhancementType[] enhancementTypes,
     ...
     */
    public com.fedex.rate.stub.PriorityAlertEnhancementType[] getEnhancementTypes() {
        return enhancementTypes;
    }
     ...
     */
    public void setEnhancementTypes(com.fedex.rate.stub.PriorityAlertEnhancementType[] enhancementTypes) {
        this.enhancementTypes = enhancementTypes;
    }

    public com.fedex.rate.stub.PriorityAlertEnhancementType getEnhancementTypes(int i) {
        return this.enhancementTypes[i];
    }

    public void setEnhancementTypes(int i, com.fedex.rate.stub.PriorityAlertEnhancementType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "PriorityAlertDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("enhancementTypes");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "EnhancementTypes"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "PriorityAlertEnhancementType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v16", "Content"));
